...
class FileProcessor:
    ...
    def extract_segments(self, content: bytes, filename: str, batch_size: int = 10) -> Generator[Tuple[str, Dict[str, Any]], None, None]:
    ...
    def _iter_pdf(self, content: bytes, filename: str, batch_size: int) -> Generator[Tuple[str, Dict[str, Any]], None, None]:
        """PDF를 페이지 묶음 단위로 처리"""
        try:
