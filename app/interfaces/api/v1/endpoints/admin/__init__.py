...
from app.interfaces.api.v1.endpoints.admin import graph, integrity, jobs, rag, storage
...
router.include_router(integrity.router, prefix="/integrity", tags=["Admin Integrity"])
