from app.domain.value_objects.ingestion_state import DecisionTrace, FailureHypothesis, IngestionGraphState
...
def test_ingestion_state_has_backtracking_context():
    ...
    state = IngestionGraphState(
        ...
        # New field
        backtracking_context={"failure_hypothesis": None, "interpretation_history": [], "decision_trace": []},
    )
