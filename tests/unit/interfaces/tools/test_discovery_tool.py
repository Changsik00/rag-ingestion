...
async def test_discovery_tool_execution():
    with (
        patch("app.interfaces.api.dependencies.get_neo4j_driver"),
        ...
        patch("app.interfaces.api.dependencies.get_google_search_client"),
        patch("app.domain.services.discovery_service.DiscoveryService") as mock_service_cls,
