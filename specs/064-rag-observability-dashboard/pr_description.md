...
- [x] **Enhancement**: `Trace Viewer`를 `Observability & Trace`로 개편 (LangFuse 대시보드 링크 및 내부 State 검색 개선).
- [x] **Fix**: Ingestion Job 완료 후 Trace 조회 시 500 에러 발생하는 문제 수정 (Auto-cleanup으로 인한 404 Graceful Handling).
