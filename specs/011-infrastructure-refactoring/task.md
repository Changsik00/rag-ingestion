...
- [x] 모든 변경사항 커밋 (8개 커밋)
- [x] 푸시: `git push origin feature/011-infrastructure-refactoring`
- [x] PR 생성: `gh pr create --title "refactor(spec-011): infrastructure layer refactoring" --body-file specs/011-infrastructure-refactoring/pr_description.md`
